require "spec"
require "../src/yacht.cr"

describe "Yacht" do
  context "Category::Yacht" do
    it "Yacht" do
      dice = [5, 5, 5, 5, 5]
  ...
  context "Category::Fives" do
    it "Yacht of 3s counted as fives" do
      dice = [3, 3, 3, 3, 3]
  ...
  context "Category::FullHouse" do
    ...
    it "Two pair is not a full house" do
      dice = [2, 2, 4, 4, 5]
  ...
  context "Category::FourOfAKind" do
  ...
  context "Category::LittleStraight" do
  ...
  context "Category::BigStraight" do
