...
describe "PhoneNumber" do
  ...
  it "valid when 11 digits and starting with 1" do
    # Excuse me Exercism, this conflicts with 'invalid when 11 digits does not start with a 1' in the previous test!
    PhoneNumber.clean("12234567890").should eq("2234567890")
  end

  it "valid when 11 digits and starting with 1 even with punctuation" do
    # Excuse me Exercism, this conflicts with 'invalid when 11 digits does not start with a 1' in the 2nd previous test!
