...
describe "HighScores" do
  ...
  pending "Scores after personal top scores" do
    high_scores = HighScores.new([30, 50, 20, 70])
  ...
  pending "Latest score after personal best" do
  ...
  pending "Scores after personal best" do
    high_scores = HighScores.new([20, 70, 15, 25, 30])
