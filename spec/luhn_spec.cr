describe "Luhn" do
  ...
  pending "invalid long number with an even remainder" do
    Luhn.valid?("1 2345 6789 1234 5678 9012").should be_false
  end

  pending "invalid long number with a remainder divisible by 5" do
  ...
  pending "very long input is valid" do
    Luhn.valid?("9999999999 9999999999 9999999999 9999999999").should be_true
  end

  pending "valid luhn with an odd number of digits and non zero first digit" do
  ...
  pending "non-numeric, non-space char in the middle with a sum that's divisible by 10 isn't allowed" do
